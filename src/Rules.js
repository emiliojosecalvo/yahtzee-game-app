...
class SmallStraight extends Rule {
  evalRoll = dice => {
    ...
    // small straight, is checking if have 234 and either 1 or 5
    if ((d.has(2) && d.has(3) && d.has(4)) && (d.has(1) || d.has(5))) {
      return this.score;
    }

    // small straight, is checking if have 345 and either 2 or 6
...
const largeStraight = new LargeStraight({ score: 40, description: '40 points for a larger straight' });
